...
fn main() {
    ...
    let _first_code = args[1].parse::<u64>().expect("64bit number");
    let _second_code = args[2].parse::<u64>().expect("64bit number");
    ...
    generate_equations(code1, &mut operations, &mut equations, &mut results);
    generate_equations(code2, &mut operations, &mut equations, &mut results);
    ...
    println!("-------------------------------------------");
    println!("Original code 1: {}", code1);
    println!("Original code 2: {}", code2);
    println!("Original code 3: {}", code3);
    println!("-------------------------------------------");
    println!("Derived code 1: {}", dc1);
    println!("Derived code 2: {}", dc2);
    println!("Derived code 3: {}", dc3);
    println!("-------------------------------------------");
}
